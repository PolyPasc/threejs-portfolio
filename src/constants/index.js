...
export const myProjects = [
	{
		title: "Podmastr -  Podcast Platform",
		desc: "Podmastr is a revolutionary Software-as-a-Service platform that transforms the way podcasts are created. With advanced features, it allows creators to generate diverse type of content.",
		subdesc:
			"Built as a unique Software-as-a-Service app with Next.js 14, Tailwind CSS, TypeScript, Framer Motion and Convex, Podmastr is designed for optimal performance and scalability.",
	...
	{
		title: "LiveDoc - Real-Time Online Docs",
	...
	{
		title: "CarePlus - Health Management System",
		desc: "An innovative healthcare platform designed to streamline essential medical processes. It simplifies patient registration, appointment scheduling, and medical record management, providing a seamless experience for both healthcare providers and patients.",
		subdesc:
			"With a focus on efficiency, CarePlus integrantes complex forms and SMS notifications, by using Next.js, Appwrite, Twillio and Sentry that enhance operational workflows.",
	...
	{
		title: "Imagica -  Photo Manipulation App",
		desc: "Imagica is a groundbreaking Software-as-a-Service application that empowers users to create stunning photo manipulations using technology. With features like image editing, a payments system, and a credits-based model.",
		subdesc:
			"Built with Next.js 14, Cloudinary, Clerk, and Stripe, Imagica combines cutting-edge technology with a user-centric approach.",
